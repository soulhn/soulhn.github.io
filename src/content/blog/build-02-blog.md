...
description: "Astro 전환, 기존 페이지는 그대로, md push→자동 발행 실증. 21분."
date: 2026-07-09
category: build
...
비교 검사로 원페이지가 한 글자도 달라지지 않았음을 증명하고, 로컬 빌드·프리뷰 확인 후 배포. 완료 기준 5개 전부 달성. 푸시 후 **36초 만에 자동 배포**되며 "md 추가 → push → 반영"이 실증됐다. 제한 시간 **21분**.
